    ...
    'comboBox_v_att_diff_bias_ig' : {
        ...
        'values' : {
            0 : {'value': bitarray('100011'),
                 'text' : '2.50 (Integrator gain (GQ1))'},
            1 : {'value': bitarray('100011'),
                 'text' : '1.00 (Integrator gain (GQ1))'},
            2 : {'value': bitarray('111000'),
                 'text' : '1.70 (Integrator gain (GQ1))'},
            3 : {'value': bitarray('100011'),
                 'text' : '3.65 (Integrator gain (GQ1))'},
            4 : {'value': bitarray('100011'),
                 'text' : '1.39 (Integrator gain (GQ1))'},
        },
    },
...
channel_data = {
    ...
    'comboBox_att' : {
        ...
        'values' : {
            ...
            1 : {'value': bitarray('001'),
                 'text' : '1.00 (Integrator gain (GQ1))'},
            2 : {'value': bitarray('011'),
                 'text' : '1.70 (Integrator gain (GQ1))'},
            3 : {'value': bitarray('100'),
                 'text' : '3.65 (Integrator gain (GQ1))'},
            4 : {'value': bitarray('101'),
                 'text' : '1.39 (Integrator gain (GQ1))'},
        },
    },
