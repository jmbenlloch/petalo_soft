...
link_status_fields = {
    ...
    "LINK_STATUS_ALIGNING_7" : reverse_range_inclusive(15, 15),
    "LINK_STATUS_ALIGNING_6" : reverse_range_inclusive(14, 14),
    "LINK_STATUS_ALIGNING_5" : reverse_range_inclusive(13, 13),
    "LINK_STATUS_ALIGNING_4" : reverse_range_inclusive(12, 12),
    "LINK_STATUS_ALIGNING_3" : reverse_range_inclusive(11, 11),
    "LINK_STATUS_ALIGNING_2" : reverse_range_inclusive(10, 10),
    "LINK_STATUS_ALIGNING_1" : reverse_range_inclusive( 9,  9),
    "LINK_STATUS_ALIGNING_0" : reverse_range_inclusive( 8,  8),
    "LINK_STATUS_ALIGNED_7"  : reverse_range_inclusive( 7,  7),
    "LINK_STATUS_ALIGNED_6"  : reverse_range_inclusive( 6,  6),
    "LINK_STATUS_ALIGNED_5"  : reverse_range_inclusive( 5,  5),
    "LINK_STATUS_ALIGNED_4"  : reverse_range_inclusive( 4,  4),
    "LINK_STATUS_ALIGNED_3"  : reverse_range_inclusive( 3,  3),
    "LINK_STATUS_ALIGNED_2"  : reverse_range_inclusive( 2,  2),
    "LINK_STATUS_ALIGNED_1"  : reverse_range_inclusive( 1,  1),
    "LINK_STATUS_ALIGNED_0"  : reverse_range_inclusive( 0,  0),
}
...
lmk_control_fields = {
    "LMK_WREN"      : reverse_range_inclusive(16, 16),
    "LMK_REG_ADD"   : reverse_range_inclusive(15,  8),
...
link_control_fields = {
    ...
    'DDR'                      : reverse_range_inclusive(13, 13),
    'SYNC_RST_CONF'            : reverse_range_inclusive(12, 12),
    'SYNC_RST_RUN'             : reverse_range_inclusive(11, 11),
