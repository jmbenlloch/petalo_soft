...
power_status_fields = {
    ...
    "PWR_STATUS_TOFPET_VCCEN_0"   : reverse_range_inclusive(15, 15),
    "PWR_STATUS_TOFPET_VCCEN_1"   : reverse_range_inclusive(14, 14),
    "PWR_STATUS_TOFPET_VCCEN_2"   : reverse_range_inclusive(13, 13),
    "PWR_STATUS_TOFPET_VCCEN_3"   : reverse_range_inclusive(12, 12),
    "PWR_STATUS_TOFPET_VCCEN_4"   : reverse_range_inclusive(11, 11),
    "PWR_STATUS_TOFPET_VCCEN_5"   : reverse_range_inclusive(10, 10),
    "PWR_STATUS_TOFPET_VCCEN_6"   : reverse_range_inclusive( 9,  9),
    "PWR_STATUS_TOFPET_VCCEN_7"   : reverse_range_inclusive( 8,  8),
    "PWR_STATUS_TOFPET_VCC25EN_0" : reverse_range_inclusive( 7,  7),
    "PWR_STATUS_TOFPET_VCC25EN_1" : reverse_range_inclusive( 6,  6),
    "PWR_STATUS_TOFPET_VCC25EN_2" : reverse_range_inclusive( 5,  5),
    "PWR_STATUS_TOFPET_VCC25EN_3" : reverse_range_inclusive( 4,  4),
    "PWR_STATUS_TOFPET_VCC25EN_4" : reverse_range_inclusive( 3,  3),
    "PWR_STATUS_TOFPET_VCC25EN_5" : reverse_range_inclusive( 2,  2),
